...
#ifdef   PSL1GHT_H_WRAPPER
#include PSL1GHT_H_WRAPPER
#else

/* Based on ./cell64lv2.humbertodias-gcc-13.2.0-PS3-PPU.h */
...
#define PSL1GHT_CELLOS_LV2_TARGET_OS_CPP_BUILTINS() \
	do												\
	{												\
		builtin_define ("__PSL1GHT");				\
...
#define TARGET_OS_CPP_BUILTINS() PSL1GHT_CELLOS_LV2_TARGET_OS_CPP_BUILTINS ()
